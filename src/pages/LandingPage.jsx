  ...
  const doctors = [
    {
      ...
      image:
        '/gads/nov25/ghaziabad/Images/Dr Gauri maam.webp',
    ...
    },
    {
      ...
      location: 'GHAZIABAD, DELHI NCR',
      image:
        '/gads/nov25/ghaziabad/Images/Dr. Ranjana Mishra.webp',
    ...
    },
    {
      ...
      location: 'GHAZIABAD, DELHI NCR',
      image:
        '/gads/nov25/ghaziabad/Images/Dr Prateek.webp',
        shortDesc: 'A dynamic IVF specialist passionate about treating secondary infertility and recurrent IVF failures. Skilled in managing complex fertility cases with precision and care. Recognized with multiple awards for excellence in reproductive medicine.',
    },
    // {
    //   name: 'Dr. Monika Maan',
    ...
    //   location: 'Pitampura, NCR Ghaziabad',
    //   image:
    //     '/gads/nov25/ghaziabad/Images/Dr. Monika Maan.webp',
    ...
    //   location: 'Faridabad, NCR Ghaziabad',
    //   image:
    //     '/gads/nov25/ghaziabad/Images/Dr. Beena Upadhyay.webp',
      ...
      <header className="fixed top-0 left-0 right-0 w-full bg-white z-50 shadow-lg">
        <div className="mx-auto max-w-7xl flex items-center justify-start sm:justify-between gap-35 px-2 py-1">
          ...
          <a href="/" className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            <img
              src="/gads/nov25/ghaziabad/Images/SOILogo.webp"
          ...
          <div className="flex flex-col items-start sm:items-center gap-1 w-auto sm:w-[210px] ml-0 sm:ml-0 flex-shrink-0">
            ...
            >
              <span className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 inline-flex items-center justify-center rounded-full bg-white shadow">
                <img
                  src="/gads/nov25/ghaziabad/Images/whatsapp_PNG20 1.webp"
                  alt="WhatsApp"
      ...
      <div className="pt-[45px] sm:pt-[65px]">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="sm:hidden mb-6">
              ...
              <div ref={serviceRow1Ref} className="flex gap-3 overflow-x-auto pb-2 mb-3 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/IUI, IVF & ICSI.webp" alt="IUI, IVF & ICSI" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">IUI, IVF & ICSI</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/Blastocyst.webp" alt="Blastocyst Transfer" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">Blastocyst Transfer</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/Cryopreservation.webp" alt="Cryopreservation" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/PRP & Ovarian.webp" alt="PRP & Ovarian Rejuvenation" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
              ...
              <div ref={serviceRow2Ref} className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/Genetic testing.webp" alt="Genetic Testing" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/Genetic.webp" alt="Genetic Counseling" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">Genetic Counseling</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/TESA PESA.webp" alt="TESA/PESA" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">TESA/PESA</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/ghaziabad/Images/Laparoscopy &.webp" alt="Laparoscopy & Hysteroscopy" className="w-12 h-12 object-contain" />
                  </div>
            ...
            <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/IUI, IVF & ICSI.webp"
                    alt="IUI, IVF & ICSI"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/Blastocyst.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/Cryopreservation.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/PRP & Ovarian.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/Genetic testing.webp"
                    alt="Genetic Testing"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                    loading="lazy"
                  />
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <img
                    src="/gads/nov25/ghaziabad/Images/Genetic.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/TESA PESA.webp"
                    alt="TESA/PESA"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                    loading="lazy"
                  />
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/ghaziabad/Images/Laparoscopy &.webp"
        ...
        <section className="w-full py-8 sm:py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Main Heading */}
            <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600 mb-4 sm:mb-6">
              Best IVF Specialists & IVF Doctors in Ghaziabad
            </h2>
            ...
            <div className="hidden sm:grid grid-cols-1 mt-20 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {doctors.map((doc) => (
                <div
                  key={doc.name}
                  className="flex flex-col items-center text-center group transition-all duration-300"
                ...
                {[
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/08.webp" alt="35+ IVF Centres" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/01.webp" alt="20,000+ Healthy Babies" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/03.webp" alt="Upto 78% Success Rate" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/06.webp" alt="30+ Certified Trained Clinicians" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                ].map((f, idx) => (
                  <div
                ...
                {[
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/02.webp" alt="Affordable IVF Care" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/04.webp" alt="Fetal Medicine" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/05.webp" alt="Expert Fertility Counsellor & Clinical Geneticist" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/ghaziabad/Images/07.webp" alt="In-House Genetic Lab" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                ].map((f, idx) => (
                  <div
              ...
              {[
                {
                  ...
                  desc:
                    "With over 35 IVF centres across the National and International, Seeds of Innocens brings fertility care closer to you. Whether you're in a metro or a smaller city, expert help is never far away. Visit your nearest centre and take the first step toward parenthood with us.",
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/08.webp" alt="35+ IVF Centres" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: '20,000+ Healthy Babies',
                  desc:
                    'At Seeds of Innocens, we are proud to have helped over 20,000 families welcome healthy babies into the world. Our commitment to quality fertility care and personalised treatment has made us a trusted name in IVF.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/01.webp" alt="20,000+ Healthy Babies" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Upto 78% Success Rate',
                  desc:
                    'We maintain an impressive IVF success rate of 78%, higher than the average. Our advanced lab technology and individualised treatment plans make this possible. We believe in transparency, trust, and results that matter.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/03.webp" alt="Upto 78% Success Rate" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: '30+ Certified Trained Clinicians',
                  desc:
                    'Our team includes over 30 certified and highly trained fertility specialists and embryologists. With years of experience and global expertise, we offer world-class treatment and compassionate care.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/06.webp" alt="30+ Certified Trained Clinicians" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Affordable IVF Care',
                  desc:
                    'We provide affordable IVF treatment and offer quality services to patients, with customised packages and financing options to make your journey easier.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/02.webp" alt="Affordable IVF Care" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Fetal Medicine',
                  desc:
                    'We offer fetal medicine services including ultrasound scans, fetal echocardiography, and diagnostic procedures like amniocentesis and CVS for comprehensive prenatal care.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/04.webp" alt="Fetal Medicine" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Expert Fertility Counsellor & Clinical Geneticist',
                  desc:
                    'Genetic counselors evaluate family histories and identify potential genetic risks that could affect reproductive outcomes, guiding you with options and implications of results.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/05.webp" alt="Expert Fertility Counsellor & Clinical Geneticist" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'In-House Genetic Lab',
                  desc:
                    'We are the first IVF centre in India to establish an in-house genetic lab with testing services including PGT-A which increases the success rate of the IVF process.',
                  icon: (
                    <img src="/gads/nov25/ghaziabad/Images/07.webp" alt="In-House Genetic Lab" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
              ].map((f, idx) => (
                <div
        ...
        <section className="w-full bg-gray-100 py-8 sm:py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Main Heading */}
            <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600 mb-4 sm:mb-6">
              About Seeds of Innocens IVF Centre Ghaziabad
            </h2>
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 p-4 sm:p-8">
              ...
              <div className="w-full max-w-xl flex-shrink-0">
                <img
                  src="/gads/nov25/ghaziabad/Images/Yashoda1.webp"
                  alt="Seeds of Innocens IVF Centre Ghaziabad building"
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="w-full lg:w-1/2 flex flex-col">
                <div className=" p-5 sm:p-6">
                  <h3 className="font-bold text-xl sm:text-2xl text-gray-900 leading-snug">Seeds of Innocens - Best IVF Centre in Ghaziabad | Fertility Clinics</h3>
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-base sm:text-lg text-gray-900">
                        <span className="font-semibold">Address:</span> opp. Nehru Stadium Jogging Track, Ram Nagar, Pocket L, Nehru Nagar III, Nehru Nagar, Ghaziabad, Uttar Pradesh 201001
                      </p>
                    </div>
                  </div>
                  <div className="mt-5 flex flex-wrap gap-3">
                    <a href="https://www.google.com/maps/place/Seeds+of+Innocens+IVF+Centre-+Best+IVF+Centre+in+Ghaziabad+%7C+Fertility+Clinic/@28.6597778,77.4364938,16z/data=!4m6!3m5!1s0x390cf1c5b4d8b201:0x6502bf0f722f09a5!8m2!3d28.6598934!4d77.4385815!16s%2Fg%2F11hbc4c3ph?entry=ttu&g_ep=EgoyMDI1MTEwNS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-red-700 transition-colors">
