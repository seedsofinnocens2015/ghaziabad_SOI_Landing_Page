...
- Navigate to `public_html/gads/nov25/ghaziabad/` folder
...
### 4. Verify
Visit: `https://www.seedsofinnocens.com/gads/nov25/ghaziabad/`

## Troubleshooting 403 Forbidden Error

### Check 1: `.htaccess` File
- Ensure `.htaccess` file is uploaded in `gads/nov25/ghaziabad/` folder
- File permissions should be `644`
- File should not be named `.htaccess.txt` (must be exactly `.htaccess`)

### Check 2: Folder Permissions
- `gads/nov25/ghaziabad/` folder should have `755` permissions
- All subfolders should have `755` permissions

### Check 3: Index File
- `index.html` must be present in `gads/nov25/ghaziabad/` folder
- File permissions should be `644`
...
```bash
cd public_html/gads/nov25/ghaziabad/
chmod 644 .htaccess
